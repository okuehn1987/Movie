...
Route::middleware(['auth', HasOrganizationAccess::class, CheckIfGateWasUsedToAuthorizeRequest::class])->group(function () {
    ...
    Route::middleware(isApp::class . ':flow')->group(function () {
        ...
        Route::get('/ticketRecordFile/{ticketRecordFile}/download', [TicketRecordController::class, 'download'])->name('ticketRecordFile.download');
        Route::delete('/ticketRecordFile/{ticketRecordFile}/deleteFile', [TicketRecordController::class, 'deleteFile'])->name('ticketRecordFile.deleteFile');
