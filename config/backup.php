...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => env('BACKUP_FILE_PREFIX', 'herta_'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('DB_BACKUP_EMAIL', 'info@mbd-team.de'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'info@herta.mbd-team.de'),
                'name' => env('MAIL_FROM_NAME', 'Herta Backup'),
            ],
        ],
