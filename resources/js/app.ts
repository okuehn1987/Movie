...
import { VDateInput, VFileUpload, VIconBtn, VVideo, VVideoVolume } from 'vuetify/labs/components';
...
const vuetify = createVuetify({
    ...
    components: { ...components, VDateInput, VFileUpload, VVideo, VVideoVolume, VIconBtn },
    directives,
});
