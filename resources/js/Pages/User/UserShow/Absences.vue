...
import { Absence, AbsenceType, RelationPick, User } from '@/types/types';
...
defineProps<{
    user: User & {
        ...
        usedLeaveDaysForYear: Record<string, number>;
                ...
                <v-row>
                    ...
                    <v-col>
                        <v-expansion-panels elevation="1" multiple v-model="openYear">
                            <template v-for="entry in usedLeaveDaysForYear" :key="entry">
                                <template v-for="(_, year) in entry" :key="year">
                                    <v-expansion-panel>
                                                        ...
                                                        <v-expansion-panel-text>
                                                            ...
                                                            >
                                                                <template v-slot:item.status="{ item }">
                                                                    <v-chip
                                                                        :color="
                                                                            { accepted: 'success', created: 'warning', declined: 'error' }[
                                                                                item.status
                                                                            ]
                                                                        "
                                                                    >
                                                                ...
                                                                <template v-slot:body.append v-if="absenceType.name == 'Urlaub'">
                                                                    ...
                                                                    <tr class="font-weight-bold">
                                                                        ...
                                                                        <td>
                                                                            {{ entry[year] + ' von ' + user.leaveDaysForYear }}
                                                                        </td>
                                                                    </tr>
                                                                </template>
                                                            </v-data-table-virtual>
