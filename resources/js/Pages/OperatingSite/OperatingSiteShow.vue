...
<template>
    <AdminLayout title="Standort">
        <v-container>
            <v-alert class="mb-4" v-if="siteForm.wasSuccessful" closable color="success">Betriebsstätte wurde erfolgreich aktualisiert.</v-alert>
            <v-card>
                <v-toolbar color="primary" :title="operatingSite.name ?? 'Betriebsort'"></v-toolbar>

                <div class="d-flex flex-row">
                    <v-tabs v-model="tab" color="primary" direction="vertical">
                        <v-tab prepend-icon="mdi-account" text="Betriebsort" value="Betriebsort"></v-tab>
                    ...
                    <v-tabs-window v-model="tab" class="w-100">
                        <v-tabs-window-item value="Betriebsort">
                            <v-form @submit.prevent="submit">
                                <v-card-text>
                                    ...
                                    <v-row>
                                        <v-col cols="12" md="6">
                                            <v-text-field label="Name" v-model="siteForm.name" variant="underlined"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="6">
                                            <v-text-field label="Email" v-model="siteForm.email" variant="underlined"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="6">
                                            <v-text-field label="Telefonnummer" v-model="siteForm.phone_number" variant="underlined"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="6">
                                            <v-text-field label="Fax" v-model="siteForm.fax" variant="underlined"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    ...
                                    <v-row>
                                        <v-col cols="12" md="4">
                                            <v-text-field label="Straße" v-model="siteForm.street" variant="underlined"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="4">
                                            <v-text-field label="Hausnummer" v-model="siteForm.house_number" variant="underlined"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="4">
                                            <v-text-field label="Adresszusatz" v-model="siteForm.address_suffix" variant="underlined"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="6">
                                            <v-text-field label="Postleitzahl" v-model="siteForm.zip" variant="underlined"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="6">
                                            <v-text-field label="Ort" v-model="siteForm.city" variant="underlined"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="6">
                                            <v-text-field label="Bundesland" v-model="siteForm.federal_state" variant="underlined"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="6">
                                            <v-checkbox label="Hauptsitz?" v-model="siteForm.is_head_quarter" variant="underlined"></v-checkbox>
                                        </v-col>
                                    </v-row>
                                </v-card-text>
                                <v-card-actions>
                        ...
                        <v-tabs-window-item value="Betriebszeiten">
                            <v-alert class="mb-4" v-if="operatingTimeForm.wasSuccessful" closable color="success">
                                Arbeitszeit wurde erfolgreich hinzugefügt.
                            </v-alert>
                            <v-form @submit.prevent="submitOperatingTime">
                                <v-card-text>
                                    ...
                                    <v-divider class="mb-8"></v-divider>
                                    <v-list>
                                        <div class="d-flex align-center" v-for="operatingTime in operatingTimes" :key="operatingTime.id">
                                            <v-list-item
                                            ...
                                            <Link
                                                ...
                                                "
                                            >
                                                <v-btn color="error" size="small"><v-icon icon="mdi-delete"></v-icon></v-btn>
                                            </Link>
                                        </div>
                                    </v-list>
                                    <div class="my-8">
                                ...
                                <v-card-actions>
                                    <div class="d-flex justify-end w-100">
                                        <v-btn type="submit" color="primary" variant="elevated">Hinzufügen</v-btn>
                                    </div>
                                </v-card-actions>
                            </v-form>
                        </v-tabs-window-item>
