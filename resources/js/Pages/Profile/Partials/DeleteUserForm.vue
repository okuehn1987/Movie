    ...
    <v-card>
        ...
        <Modal v-model="confirmingUserDeletion" title="Account löschen">
            <v-form @submit.prevent="deleteUser">
                <v-card-text>
                    Sobald Ihr Konto gelöscht ist, werden alle Ihre Ressourcen
                    und Daten dauerhaft gelöscht. Bitte geben Sie Ihr Passwort
                    erneut ein, um zu bestätigen, dass Sie Ihr Konto dauerhaft
                    löschen möchten.
                </v-card-text>
                <v-text-field
